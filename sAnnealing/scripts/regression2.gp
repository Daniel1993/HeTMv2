...
# c_An=1.0
# d_An=1.0
stats sprintf("%s.data", ARG1) using 2 nooutput
...
stats sprintf("%s.data", ARG1) using 5 nooutput
MinY = STATS_min
MaxY = STATS_max
...
plot \
     sprintf("%s.data1", ARG1) using ($2/xunit):($5+(rand(0)-0.5)/2) notitle axis x1y2 \
     with dots linecolor rgbcolor "#BA009A", \
     sprintf("%s.data2", ARG1) using ($2/xunit):($5+(rand(0)-0.5)/2) notitle axis x1y2 \
     with dots linecolor rgbcolor "#FEEF00", \
     sprintf("%s.data3", ARG1) using ($2/xunit):($5+(rand(0)-0.5)/2) notitle axis x1y2 \
     with dots linecolor rgbcolor "#4F41F3", \
     sprintf("%s.data", ARG1) using ($2/xunit):($5+(rand(0)-0.5)/2) notitle axis x1y2 \
     ...
     1/0 with points linecolor rgbcolor "#4F41F3"  pt 5 lw 3 ps 1 ti keySAwarm, \
     1/0 with points linecolor rgbcolor "#FEEF00"  pt 5 lw 3 ps 1 ti keySAhot, \
     1/0 with points linecolor rgbcolor "#BA009A"  pt 5 lw 3 ps 1 ti keySAhotter, \
     1/0 with points linecolor rgbcolor "#FF0000"  pt 5 lw 3 ps 1 ti keySAhottest
