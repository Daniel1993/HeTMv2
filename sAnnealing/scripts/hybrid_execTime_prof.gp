...
FIT_PARAM_AVG = int(ARG5 + 5)
FIT_PARAM_STD = int(ARG5 + 6)

stats sprintf("%s.data2.%s", ARG1, ARG4) using 1 nooutput
Solution = ARG3
MinX = STATS_min
MaxX = STATS_max
...
if (ARG2[strlen(ARG2)-2:] eq 'tex') {
     ...
     #set terminal cairolatex size 4,3
     set terminal pdf noenhanced size 30,4
     ...
     set terminal postscript eps size 8,6
...
set ytics nomirror
set xlabel "number of vertices in SCC"
...
plot \
     sprintf("%s.hydata.%s", ARG1, ARG4) using ($1-0.3):FIT_PARAM_10P:FIT_PARAM_MIN:FIT_PARAM_MAX:FIT_PARAM_90P axis x1y1 \
          ti "Hybrid" with candlesticks linecolor rgbcolor "#FF0000" whiskerbars, \
     "" using ($1-0.3):FIT_PARAM_MED:FIT_PARAM_MED:FIT_PARAM_MED:FIT_PARAM_MED axis x1y1 notitle \
          with candlesticks linecolor rgbcolor "#AA0000" whiskerbars, \
     "" using ($1-0.3):FIT_PARAM_MED axis x1y1 notitle \
          with lines linecolor rgbcolor "#FF0000" lt 3, \
     sprintf("%s.data2.%s", ARG1, ARG4) using ($1):FIT_PARAM_10P:FIT_PARAM_MIN:FIT_PARAM_MAX:FIT_PARAM_90P axis x1y1 \
          ti "SA hot"  with candlesticks linecolor rgbcolor "#FFA042" whiskerbars, \
     "" using ($1):FIT_PARAM_MED:FIT_PARAM_MED:FIT_PARAM_MED:FIT_PARAM_MED axis x1y1 notitle \
          with candlesticks linecolor rgbcolor "#AA6012" whiskerbars, \
     "" using ($1):FIT_PARAM_MED axis x1y1 notitle \
          with lines linecolor rgbcolor "#FFA042" lt 3, \
     "" every 20:3 using ($1):FIT_PARAM_MED:FIT_PARAM_MED:FIT_PARAM_MED:FIT_PARAM_MED:xticlabel(2) axis x1y1 notitle \
          with candlesticks linecolor rgbcolor "#AA6012" whiskerbars, \
     sprintf("%s.bb.%s", ARG1, ARG4) using ($1+0.3):FIT_PARAM_10P:FIT_PARAM_MIN:FIT_PARAM_MAX:FIT_PARAM_90P axis x1y1 \
          ti "BB" with candlesticks linecolor rgbcolor "#13FF03" whiskerbars, \
     "" using ($1+0.3):FIT_PARAM_MED axis x1y1 notitle \
          with lines linecolor rgbcolor "#13FF03" lt 3, \
     "" using ($1+0.3):FIT_PARAM_MED:FIT_PARAM_MED:FIT_PARAM_MED:FIT_PARAM_MED axis x1y1 notitle \
          with candlesticks linecolor rgbcolor "#03AA00" whiskerbars \


# plot \
#      sprintf("%s.hydata.%s", ARG1, ARG4) using ($1-0.3):($8 - $9):($8 - $9):($8 + $9):($8 + $9) axis x1y1 \
#           ti "Hybrid" with candlesticks linecolor rgbcolor "#FF0000" whiskerbars, \
#      "" using ($1-0.3):FIT_PARAM_AVG:FIT_PARAM_AVG:FIT_PARAM_AVG:FIT_PARAM_AVG axis x1y1 notitle \
#           with candlesticks linecolor rgbcolor "#AA0000" whiskerbars, \
#      sprintf("%s.data2.%s", ARG1, ARG4) using ($1):($8 - $9):($8 - $9):($8 + $9):($8 + $9) axis x1y1 \
#           ti "SA hot"  with candlesticks linecolor rgbcolor "#FFA042" whiskerbars, \
#      "" using ($1):FIT_PARAM_AVG:FIT_PARAM_AVG:FIT_PARAM_AVG:FIT_PARAM_AVG axis x1y1 notitle \
#           with candlesticks linecolor rgbcolor "#AA6012" whiskerbars, \
#      "" every 20:3 using ($1):FIT_PARAM_AVG:FIT_PARAM_AVG:FIT_PARAM_AVG:FIT_PARAM_AVG:xticlabel(2) axis x1y1 notitle \
#           with candlesticks linecolor rgbcolor "#AA6012" whiskerbars, \
#      sprintf("%s.bb.%s", ARG1, ARG4) using ($1+0.3):($8 - $9):($8 - $9):($8 + $9):($8 + $9) axis x1y1 \
#           ti "BB" with candlesticks linecolor rgbcolor "#13FF03" whiskerbars, \
#      "" using ($1+0.3):FIT_PARAM_AVG:FIT_PARAM_AVG:FIT_PARAM_AVG:FIT_PARAM_AVG axis x1y1 notitle \
#           with candlesticks linecolor rgbcolor "#03AA00" whiskerbars \
