...
plot \
     sprintf("%s.max_cost", ARG1) using ($1 + 0.5):($2 * Solution) w lines ti sprintf("%s* d(v)log(V)", Solution) dt 2, \
     sprintf("%s.data.%s", ARG1, ARG4) using ($1-0.3):FIT_PARAM_10P:FIT_PARAM_MIN:FIT_PARAM_MAX:FIT_PARAM_90P:xtic(2) axis x1y1 \
     ...
     sprintf("%s.cold.%s", ARG1, ARG4) using ($1-0.15):FIT_PARAM_10P:FIT_PARAM_MIN:FIT_PARAM_MAX:FIT_PARAM_90P axis x1y1 \
          ti "SA cold"  with candlesticks linecolor rgbcolor "#0000FF" whiskerbars, \
     "" using ($1-0.15):FIT_PARAM_MED:FIT_PARAM_MED:FIT_PARAM_MED:FIT_PARAM_MED axis x1y1 notitle \
          with candlesticks linecolor rgbcolor "#000000" whiskerbars, \
     sprintf("%s.data1.%s", ARG1, ARG4) using ($1):FIT_PARAM_10P:FIT_PARAM_MIN:FIT_PARAM_MAX:FIT_PARAM_90P axis x1y1 \
     ...
     "" using ($1):FIT_PARAM_MED:FIT_PARAM_MED:FIT_PARAM_MED:FIT_PARAM_MED axis x1y1 notitle \
          with candlesticks linecolor rgbcolor "#000000" whiskerbars, \
     sprintf("%s.data2.%s", ARG1, ARG4) using ($1+0.15):FIT_PARAM_10P:FIT_PARAM_MIN:FIT_PARAM_MAX:FIT_PARAM_90P axis x1y1 \
          ti "SA hot" with candlesticks linecolor rgbcolor "#FFA042" whiskerbars, \
     "" using ($1+0.15):FIT_PARAM_MED:FIT_PARAM_MED:FIT_PARAM_MED:FIT_PARAM_MED axis x1y1 notitle \
          with candlesticks linecolor rgbcolor "#000000" whiskerbars, \
     sprintf("%s.data3.%s", ARG1, ARG4) using ($1+0.3):FIT_PARAM_10P:FIT_PARAM_MIN:FIT_PARAM_MAX:FIT_PARAM_90P axis x1y1 \
          ti "SA warm" with candlesticks linecolor rgbcolor "#FF1D8C" whiskerbars, \
     "" using ($1+0.3):FIT_PARAM_MED:FIT_PARAM_MED:FIT_PARAM_MED:FIT_PARAM_MED axis x1y1 notitle \
          with candlesticks linecolor rgbcolor "#000000" whiskerbars 
# sprintf("%s.bb.%s", ARG1, ARG4) using ($1+0.15):FIT_PARAM_10P:FIT_PARAM_MIN:FIT_PARAM_MAX:FIT_PARAM_90P axis x1y2 \
