...
stats sprintf("%s.data.%s", ARG1, ARG4) using 2 nooutput
Solution = ARG3
MinX = STATS_min
MaxX = STATS_max
...
plot \
     sprintf("%s.data.%s", ARG1, ARG4) using ($2-0.3):FIT_PARAM_10P:FIT_PARAM_MIN:FIT_PARAM_MAX:FIT_PARAM_90P:xtic(1) axis x1y1 \
     ...
     sprintf("%s.cold.%s", ARG1, ARG4) using ($2-0.15):FIT_PARAM_10P:FIT_PARAM_MIN:FIT_PARAM_MAX:FIT_PARAM_90P axis x1y1 \
     ...
     "" using ($2):FIT_PARAM_MED:FIT_PARAM_MED:FIT_PARAM_MED:FIT_PARAM_MED axis x1y1 notitle \
          with candlesticks linecolor rgbcolor "#000000" whiskerbars \
     # sprintf("%s.greedy.%s", ARG1, ARG4) using ($2):FIT_PARAM_10P:FIT_PARAM_MIN:FIT_PARAM_MAX:FIT_PARAM_90P axis x1y1 \
     #      ti "Greedy" with candlesticks linecolor rgbcolor "#FFA042" whiskerbars, \
     # "" using ($2):FIT_PARAM_MED:FIT_PARAM_MED:FIT_PARAM_MED:FIT_PARAM_MED axis x1y1 notitle \
     #      with candlesticks linecolor rgbcolor "#000000" whiskerbars \
