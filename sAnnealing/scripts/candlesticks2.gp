...
plot \
     sprintf("%s.data.%s", ARG1, ARG4) using ($1-0.3):FIT_PARAM_10P:FIT_PARAM_MIN:FIT_PARAM_MAX:FIT_PARAM_90P:xtic(2) axis x1y2 \
          ti "SA hot" with candlesticks linecolor rgbcolor "#FF0000" whiskerbars, \
     ...
     sprintf("%s.cold.%s", ARG1, ARG4) using ($1-0.15):FIT_PARAM_10P:FIT_PARAM_MIN:FIT_PARAM_MAX:FIT_PARAM_90P axis x1y2 \
     ...
     "" using ($1-0.15):FIT_PARAM_MED:FIT_PARAM_MED:FIT_PARAM_MED:FIT_PARAM_MED axis x1y2 notitle \
          with candlesticks linecolor rgbcolor "#000000" whiskerbars, \
     sprintf("%s.greedy.%s", ARG1, ARG4) using ($1):FIT_PARAM_10P:FIT_PARAM_MIN:FIT_PARAM_MAX:FIT_PARAM_90P axis x1y2 \
          ti "Greedy" with candlesticks linecolor rgbcolor "#11DD22" whiskerbars, \
     "" using ($1):FIT_PARAM_MED:FIT_PARAM_MED:FIT_PARAM_MED:FIT_PARAM_MED axis x1y2 notitle \
          with candlesticks linecolor rgbcolor "#000000" whiskerbars, \
     sprintf("%s.gnoinit.%s", ARG1, ARG4) using ($1+0.15):FIT_PARAM_10P:FIT_PARAM_MIN:FIT_PARAM_MAX:FIT_PARAM_90P axis x1y2 \
          ti "Greedy (no init)" with candlesticks linecolor rgbcolor "#FF48C4" whiskerbars, \
     "" using ($1+0.15):FIT_PARAM_MED:FIT_PARAM_MED:FIT_PARAM_MED:FIT_PARAM_MED axis x1y2 notitle \
          with candlesticks linecolor rgbcolor "#000000" whiskerbars \
