...
###########################################################################
############### GPU-only
make clean ; make CMP_TYPE=COMPRESSED DISABLE_RS=1 USE_TSX_IMPL=$USE_TSX CPUEn=0 PR_MAX_RWSET_SIZE=50 \
...
############## CPU-only
make clean ; make INST_CPU=0 GPUEn=0 LOG_TYPE=VERS USE_TSX_IMPL=$USE_TSX PR_MAX_RWSET_SIZE=50 \
	BANK_PART=10 BANK_INTRA_CONFL=0.0 GPU_PART=0.55 CPU_PART=0.55 P_INTERSECT=0.00 PROFILE=1 -j 14 \
	BMAP_GRAN_BITS=13 BANK_PART_SCALE=1 >/dev/null
### 90% writes
...
DURATION=$DURATION_ORG
############## VERS
make clean ; make CMP_TYPE=COMPRESSED LOG_TYPE=VERS USE_TSX_IMPL=$USE_TSX PR_MAX_RWSET_SIZE=50 \
	BANK_PART=10 BANK_INTRA_CONFL=0.0 GPU_PART=0.55 CPU_PART=0.55 P_INTERSECT=0.00 PROFILE=1 -j 14 \
...
###########################################################################
############### GPU-only
make clean ; make CMP_TYPE=COMPRESSED DISABLE_RS=1 USE_TSX_IMPL=$USE_TSX CPUEn=0 PR_MAX_RWSET_SIZE=500 \
	BANK_PART=10 BANK_INTRA_CONFL=0.0 GPU_PART=0.55 CPU_PART=0.55 P_INTERSECT=0.00 PROFILE=1 -j 14 \
...
############## CPU-only
make clean ; make INST_CPU=0 GPUEn=0 LOG_TYPE=VERS USE_TSX_IMPL=$USE_TSX PR_MAX_RWSET_SIZE=500 \
	BANK_PART=10 BANK_INTRA_CONFL=0.0 GPU_PART=0.55 CPU_PART=0.55 P_INTERSECT=0.00 PROFILE=1 -j 14 \
	BMAP_GRAN_BITS=13 BANK_PART_SCALE=50 >/dev/null
### 90% writes
doRunLargeDTST_CPU CPUonly_rand_sep_DISABLED_large
...
DURATION=$DURATION_ORG
############## VERS
make clean ; make CMP_TYPE=COMPRESSED LOG_TYPE=VERS USE_TSX_IMPL=$USE_TSX PR_MAX_RWSET_SIZE=500 \
	BANK_PART=10 BANK_INTRA_CONFL=0.0 GPU_PART=0.55 CPU_PART=0.55 P_INTERSECT=0.00 PROFILE=1 -j 14 \
	BMAP_GRAN_BITS=13 DISABLE_NON_BLOCKING=1 OVERLAP_CPY_BACK=0 \
...
mkdir -p no_conflicts_inc_duration
mv *_s* no_conflicts_inc_duration/
